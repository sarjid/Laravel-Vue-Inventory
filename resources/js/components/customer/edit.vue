       ...
       <div class="row container">
         <div class="card col-lg-12">
          <div class="card-header">
            ...
            Update Customer 
            <router-link to="/all-supplier" class="btn btn-sm btn-info " style="float:right;" id="add_new"> All Customer</router-link>
          </div>
          <div class="card-body">
	          ...
	          <div class="form-group">
               ...
               <button type="submit" class="btn btn-info mt-3">Update Customer</button>
              </form>
          </div>
         </div>
       </div>
