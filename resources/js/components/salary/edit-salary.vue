         ...
         <div class="card col-lg-12">
          ...
          <div class="card-body">
	              ...
	              <div class="form-row">
	               <div class="col-md-4 mt-2">
	                <div class="form-label-group">
	                  <input type="text"  class="form-control" v-model="form.employee.name">
	                  ...
	                  <label for="firstName">Full Name</label>
				        ...
				        <div class="col-md-4 mt-2">
	                <div class="form-label-group">
	                  <input type="text"  class="form-control" v-model="form.employee.phone" >
                   ...
                   <div class="col-md-4 mt-2">
	                <div class="form-label-group">
	                  <input type="text"  class="form-control" v-model="form.employee.email" >
              ...
              <div class="form-group">
               ...
               <button type="submit" class="btn btn-danger mt-3">Update Now</button>
              </form>
          </div>
         </div>
       </div>
